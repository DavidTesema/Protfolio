      ...
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16 dark:bg-gray-900 ">
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className="hidden md:flex ">
            ...
            <li className="ml-10 text-sm uppercase hover:border-b dark:text-white">
              <a target="_blank" href="https://content.celero.io/s/9a6a90bc/david-tesema-cv/">Resume </a>
            </li>
            <li
              onClick={() => {
        ...
        >
          ...
          <div className="py-4 flex flex-col">
            <ul className="uppercase">
              ...
              <a target="_blank" href="https://content.celero.io/s/9a6a90bc/david-tesema-cv/">
                <li onClick={() => setNav(false)} className="py-4 text-sm">
                  Resume
                </li>
              </a>
            ...
            <div className="pt-40">
              <p className="uppercase tracking-widest text-[#822626]">
                Let&#39;s Connect
              </p>
